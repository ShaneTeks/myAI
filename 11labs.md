...
Native client tools
A big part of building ElevenLabs agents is allowing the agent access and execute functionality dynamically. This can be done via client tools.
...
2
Create a new agent
Navigate to Agents Platform > Agents and create a new agent from the blank template.
