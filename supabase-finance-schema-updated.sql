-- Updated Finance Database Schema for Supabase
-- Optimized for Namibian banking with monthly partitioning

-- 1. Create main transactions table (will be partitioned by month)
...
BEGIN
    ...
    IF p_pricing_option = 'EPO' AND bundle_limit > 0 THEN
        ...
        ELSE
            ...
            DECLARE
                over_amount DECIMAL := (p_monthly_bundle_used + p_amount) - bundle_limit;
                over_blocks INTEGER := CEIL(over_amount / 500.0);
            BEGIN
